...
realTimeGraph::realTimeGraph(std::string nameOfTheWindow, std::shared_ptr<Buffer> ptr)
    ...
    ptrVertices = std::make_unique<plot::Curve>(gridAreaPositionX + gridAreaWidth);
    // create the window
    initializeWindow();
...
//TODO: move this to Boundaries class
